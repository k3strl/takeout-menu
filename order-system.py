...
def update_order(order, menu_selection, menu_items):
    ...
    try:
        ...
        if menu_selection in menu_items:
            ...
            quantity_input = input(f"How many {item_name} would you like? If a number is not entered, the quantity will default to 1.")
